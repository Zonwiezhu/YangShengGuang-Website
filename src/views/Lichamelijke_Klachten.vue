            ...
            <div class="Introduction">
                ...
                <section>
                    ...
                    <details>
                        ...
                        <p>
                            Angst is een gevoel van onrust, zorgen of onbehagen, vaak gepaard met lichamelijke sensaties zoals een verhoogde hartslag, zweten en een droge mond.
                            Het is een normale menselijke reactie op stressvolle situatie, maar kan ook een aandoening zijn wanneer het zich voordoet zonder aanwijsbare oorzaak en het dagelijkse leven belemmert.
                        </p>
                    </details>
                    <details>
                    ...
                    <details>
                        <summary>Hernia</summary>
                        <p>
                            Een hernia is een aandoening waarbij een deel van een orgaan of weefsel door een opening in de omringende spieren of weefsel wordt geduwd.
                            Het komt het meest voor in de rug, waarbij een deel van de tussenwervelschijf uitpuilt en tegen een zenuw drukt, wat kan leiden tot pijn, zwate en gevoelloosheid in de benen.
                            Risicofactoren voor een hernia zijn onder ander zwaar tillen, overgewicht, zittend werk en veroudering.
                        </p>
                    </details>
                    <details>
                        <summary>Astma; Bronchitis</summary>
                        <p>
                            Astma is een chronologische ontsteking van de luchtwegen die leidt tot vernauwing en obstructie van de luchtwegen, waardoor ademhalingsproblemen ontstaan.
                            Symptonen van astma zijn onder andere piepende ademhaling, kortademigheid, hoesten en beklemming op de borst.
                            Astma kan worden veroorzaakt door allergenen, luchtvervuiling, roken, infecties en lichamelijke activiteit.
                        </p>
                    </details>
                    <details>
                        <summary>Trigeminusneuralgie</summary>
                        <p>
                            Trigeminusneuralgie is een aandoening waarbij hevige, scherpe pijn optreedt in de gezichtszenuw. 
                            De pijn kan worden veroorzaakt door verschillende triggers, zoals het aanraken van het gezicht, spreken of kauwen.
                            Trigeminusneuralgie kan worden veroorzaakt door compressie van de zenuw of een aandoening zoals multiple scelrose.
                        </p>
                    </details>
                    <details>
                    ...
                    <details>
                        <summary>Vruchtbaarheid</summary>
                        <p>
                            Vruchtbaarheid verwijst naar het vermogen van een persoon om een zwangerschap tot stant te brengen en te dragen. 
                            Bij vrouwen kan vruchtbaarheid worden beïnvloed door verschillende factoren, zoals leeftijd, hormonale disbalans, 
                            onderliggende medische aandoeningen of leefstijlfactoren.
                        </p>
                    </details>
                    <details>
                    ...
                    <details>
                        <summary>Schildklieraandoening</summary>
                        <p>
                    ...
                    <details>
                        ...
                        <p>
                            Migraine is een neurologische aandoening die wordt gekenmerkt door terugkerende hoofdpijn die kan worden vegezeld door andere symptonen zoals misselijkheid, braken en gevoeligheid voor licht en geluid.
                            Migraineaanvallen kunnen enkele uren tot meerdere dagen duren en kunnen verstorend zijn voor de dagelijkse activiteiten. 
                            De oorzaken van migraine zijn nog niet volledig begrepen, maar het wordt verondersteld dat genetische factoren en omgevingsfactoren een rol spelen.
            ...
            <div class="banner-content">
                ...
                <div class= "main-banner1">
                    <div class="img-container">
                        <img src="/src/assets/Afbeeldingen/Kruiden.png" alt="" >
                    </div>
                </div>
